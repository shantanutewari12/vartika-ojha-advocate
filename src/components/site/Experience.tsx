...
const cases = [
  { org: "Invisible Technologies", role: "Master Law Specialist - AI Trainer", file: "VO/2024-001" },
    ...
    <section id="experience" className="relative py-20 md:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-6">
        <SectionTitle
          ...
          subtitle="A record of offices, commissions, and councils where research, drafting, and counsel have been rendered."
        />
          ...
          {cases.map((c, i) => (
            ...
            >
              ...
              <div className="p-7">
                ...
                <h3 className="mt-3 font-display text-2xl leading-tight text-mahogany">{c.org}</h3>
